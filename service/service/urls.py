...
from library.views import AuthorModelViewSet, BiographyViewSet, BookViewSet
...
pagination_router.register('userpagenumber', userapp.views.UserPageNumberPaginationViewSet)
pagination_router.register('userlimitoffset', userapp.views.UserLimitOffsetPaginationViewSet)
